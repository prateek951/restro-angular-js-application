    ...
    if (!r.hasClass("revslider-initialised")) {
          ...
          if (
            ...
            e("head")
              ...
              .each(function() {
                if (
                  e(this).attr("src") ==
                  C + "://a.vimeocdn.com/js/froogaloop2.min.js"
                )
                  o = false;
              });
      ...
      if (i.shuffle == "on") {
        ...
        for (var O = 0; O < r.find(">ul:first-child >li").length; O++) {
          ...
          r
            .find(">ul:first-child >li:eq(" + M + ")")
            .prependTo(r.find(">ul:first-child"));
        }
      ...
      r.find(".tp-scrollbelowslider").on("click", function() {
        ...
        try {
          t = e("body")
            .find(i.fullScreenOffsetContainer)
            .height();
        } catch (n) {}
        try {
        ...
        if (window.tplogs == true)
          try {
            console.groupCollapsed(
              "Slider Revolution 4.5.7 Initialisation on " + e(this).attr("id")
            );
  ...
  var O = function(n, r, i, s, o, u) {
    ...
    if (a == 0) {
      ...
      u.find(".slotslide").each(function(t) {
        ...
        if (A == L) A = 0;
        k.add(
          punchgs.TweenLite.from(n, C / 600, {
            opacity: 0,
            top: 0 - r.sloth,
            left: 0 - r.slotw,
            rotation: r.rotate,
    ...
    if (a == 1) {
      ...
      u.find(".slotslide").each(function(t) {
        ...
        k.add(
          punchgs.TweenLite.from(n, rand / 1e3, {
            autoAlpha: 0,
            force3D: "auto",
            rotation: r.rotate,
    ...
    if (a == 2) {
      ...
      u.find(".slotslide").each(function() {
        var t = e(this);
        D.add(
          punchgs.TweenLite.from(t, C / 1e3, {
            left: 0 - r.slotw,
            force3D: "auto",
            rotation: r.rotate
          }),
    ...
    if (a == 6) {
      ...
      o.find(".slotslide").each(function(t) {
        ...
        D.add(
          punchgs.TweenLite.to(n, (C + i) / 1e3, {
            top: 0 + r.height,
            opacity: 1,
            force3D: "auto",
            rotation: r.rotate,
      ...
      u.find(".slotslide").each(function(t) {
        ...
        D.add(
          punchgs.TweenLite.from(n, (C + i) / 1e3, {
            top: 0 - r.height,
            opacity: 1,
            force3D: "auto",
            rotation: r.rotate,
      ...
      u.find(".slotslide").each(function(t) {
        ...
        k.add(
          punchgs.TweenLite.fromTo(
            ...
            { autoAlpha: 1, ease: punchgs.Power2.easeInOut, delay: t * 5 / 1e3 }
          ),
          0
        );
      });
    ...
    if (a == 11 || a == 26) {
      ...
      u.find(".slotslide").each(function(t) {
        var n = e(this);
        k.add(
          punchgs.TweenLite.from(n, C / 1e3, {
            autoAlpha: 0,
            force3D: "auto",
            ease: punchgs.Power2.easeInOut
          }),
    ...
    if (a == 16) {
      ...
      var et = Math.round(Math.random() * 20 - 10),
        ...
        st = Math.random() * 0.4 - 0.2,
        ot = Math.random() * 1 + 1,
        ut = Math.random() * 1 + 1,
        at = Math.random() * 0.3 + 0.3;
      k.add(
  ...
  var I = function(n, r, i, s) {
    ...
    f.each(function(n) {
      ...
      if (d == 0) {
        ...
        if (u < 0) u = 0;
        if (
          f.hasClass("tp-videolayer") ||
          f.find("iframe").length > 0 ||
          ...
          var v = "iframe" + Math.round(Math.random() * 1e5 + 1),
            ...
            N = "http",
            C =
              f.data("videoloop") == "loop"
                ? "loop"
                : f.data("videoloop") == "loopandnoslidestop"
                  ? "loop"
                  : "";
          ...
          f.find("iframe").each(function() {
            ...
            if (
              f.data("videoposter") != t &&
              f.data("videoposter").length > 2 &&
              f.data("autoplay") != true &&
              !s
            ) {
            ...
            if (
              ...
              if (!n.hasClass("HasListener")) {
                ...
                if (
                  !Q() &&
                  (f.data("autoplay") == true || f.data("forcerewind") == "on")
                ) {
                  var n = f.find("iframe");
                  var g = n.attr("id");
                  var y = $f(g);
        ...
        if (!s) {
          ...
          if (
            ...
            if (f.find("a").length > 0)
              f.data(
                "mySplitText",
                new punchgs.SplitText(f.find("a"), {
              ...
              f.data(
                "mySplitText",
                new punchgs.SplitText(f.find(".tp-layer-inner-rotation"), {
                  type: "lines,words,chars",
                  charsClass: "tp-splitted",
                  wordsClass: "tp-splitted",
                  linesClass: "tp-splitted"
          ...
          pt.ease = ht.ease =
            f.data("easing") == t ? punchgs.Power1.easeInOut : f.data("easing");
          ht.data = new Object();
          ht.data.oldx = ht.x;
          ht.data.oldy = ht.y;
          pt.data = new Object();
            ...
            if (f.hasClass("customin")) {
              ...
              if (f.hasClass("randomrotate") && ct != f) {
                for (var n = 0; n < ct.length; n++) {
                  ...
                  lt.append(
                    punchgs.TweenLite.fromTo(ct[n], st, mt, gt),
                    "frame0"
                  );
                }
    ...
    n.find(".rs-pendulum").each(function() {
      ...
      if (n.data("timeline") == t) {
        ...
        (speed = n.data("speed") == t ? 2 : n.data("speed")),
          ...
          (easing =
            n.data("ease") == t ? punchgs.Power2.easeInOut : n.data("ease"));
        i = i * r;
        s = s * r;
        n
          .data("timeline")
        ...
        n.data("timeline").append(
          new punchgs.TweenLite.fromTo(
            n,
            speed,
            { force3D: "auto", rotation: s, transformOrigin: origin },
            {
              rotation: i,
              ease: easing,
              onComplete: function() {
