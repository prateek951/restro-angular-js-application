!(function(e) {
  ...
  if (!e[t]) {
    var i = {},
      ...
      o = {},
      l = !1,
      d = { $wndw: null, $html: null, $body: null };
    (e[t] = function(n, s, i) {
      (this.$menu = n),
        (this.opts = s),
        (this.conf = i),
      ...
      (e[t].prototype = {
          ...
          if (
            ...
            l.each(function() {
              ...
              if (o.parent().is("." + i.list) && !n.data(a.parent)) {
                n.data(a.parent, o);
                var r = e(
                  '<a class="' + i.subopen + '" href="#' + n.attr("id") + '" />'
                ).insertBefore(l);
                l.is("a") || r.addClass(i.fullsubopen),
                  t.opts.slidingSubmenus &&
                    s.prepend(
                      '<li class="' +
                        i.subtitle +
                        '"><a class="' +
            ...
            var r = this.__findAddBack(n, "." + i.list).find(
              "> li." + i.selected
            );
            r
              .parents("li")
              ...
              .each(function() {
                var n = e(this),
                  t = n.find("> ." + i.panel);
                t.length &&
                  (n.parents("." + i.panel).addClass(i.subopened),
                  t.addClass(i.opened));
              })
              .closest("." + i.panel)
              .addClass(i.opened)
        ...
        _initAnchors: function() {
          ...
          d.$body.on(o.click, "a", function(s) {
            ...
            for (var u in e[t].addons)
              if (
                e[t].addons[u]._clickAnchor &&
                (l = e[t].addons[u]._clickAnchor.call(n, a, r))
              )
                break;
            if (!l && r) {
              var c = a.attr("href") || "";
              if ("#" == c.slice(0, 1))
                try {
                  e(c, n.$menu).is("." + i.panel) &&
                    ((l = !0),
                    e(c).trigger(n.opts.slidingSubmenus ? o.open : o.toggle));
                } catch (p) {}
            }
            if (
              (l && s.preventDefault(),
              ...
              n.__valueOrFn(n.opts.onClick.setSelected, a) &&
                a.parent().trigger(o.setSelected);
              var h = n.__valueOrFn(
              ...
              h && s.preventDefault(),
                n.__valueOrFn(n.opts.onClick.blockUI, a, !h) &&
                  d.$html.addClass(i.blocking),
                n.__valueOrFn(n.opts.onClick.close, a, h) &&
                  n.$menu.trigger(o.close);
            }
          });
        },
        _initEvents: function() {
          ...
          this.$menu.on(
            ...
            this.opts.slidingSubmenus
              ? this.$menu.on(o.open, "." + i.panel, function() {
                  return n._openSubmenuHorizontal(e(this));
                })
              : this.$menu
                  .on(o.toggle, "." + i.panel, function() {
                    var n = e(this);
        ...
        _openSubmenuHorizontal: function(n) {
          ...
          return (
            ...
            n.hasClass(i.opened)
              ...
              : (n.addClass(i.highest), s.addClass(i.subopened)),
...
!(function(e) {
  ...
  (e[t].addons[o] = {
    ...
    _setup: function() {
      if (this.opts[o]) {
        var t = this,
          s = this.opts[o],
          p = this.conf[o];
        "string" != typeof p.pageSelector &&
          (p.pageSelector = "> " + p.pageNodetype),
    ...
    (e[t].prototype._openSetup = function() {
      ...
      this.opts[o].modal && t.push(n.modal),
        ...
        "back" != this.opts[o].zposition &&
          t.push(n.mm(this.opts[o].zposition)),
          ...
          function() {
            e.$menu.removeClass(n.current).removeClass(n.opened),
              a.$html
                ...
                .removeClass(n.mm(e.opts[o].position))
                .removeClass(n.mm(e.opts[o].zposition)),
    ...
    (e[t].prototype.setPage = function(t) {
      t ||
        ((t = e(this.conf[o].pageSelector, a.$body)),
        t.length > 1 &&
  ...
  (t[n].addons[a] = {
    _init: function(n) {
      this.opts[a],
        ...
        this.__refactorClass(
          t("div", n),
          this.conf.classNames[a].buttonbar,
          "buttonbar"
        ),
    ...
    (t[n].defaults[a] = {}),
    (t[n].configuration.classNames[a] = { buttonbar: "Buttonbar" });
  var i, o, r, s;
})(jQuery);
/*	
...
!(function(t) {
  ...
  (t[e].addons[n] = {
      ...
      this.conf[n],
        ...
        d.add &&
          e.each(function() {
            ...
            e &&
              (e.find("> em." + a.counter).length ||
                e.prepend(t('<em class="' + a.counter + '" />')));
          }),
        d.update &&
          e.each(function() {
            var e = t(this),
            ...
            if (n) {
              ...
              d.length &&
                (e.is("." + a.list) || (e = e.find("> ." + a.list)),
                e.length &&
                  !e.data(o.updatecounter) &&
                  (e.data(o.updatecounter, !0),
                  s._update(function() {
                    var t = e
                      .children()
                      .not("." + a.label)
    ...
    _setup: function() {
      var a = this.opts[n];
      "boolean" == typeof a && (a = { add: a, update: a }),
        "object" != typeof a && (a = {}),
        (a = t.extend(!0, {}, t[e].defaults[n], a)),
        (this.opts[n] = a);
    },
    _add: function() {
      (a = t[e]._c),
    ...
    _setup: function() {
      if (this.opts.offCanvas) {
        var s = this,
          ...
          d = this.conf[o];
        if (
          ("boolean" == typeof p && (p = { open: p }),
          "object" != typeof p && (p = {}),
          (p = e.extend(!0, {}, e[n].defaults[o], p)),
          p.open)
        ) {
          ...
          $.on("panstart", function(e) {
            ...
            .on(u.events, function(e) {
              if (
                ((f = e["delta" + u.typeUpper]),
                u.negative && (f = -f),
                f != _ && (l = f >= _ ? u.open_dir : u.close_dir),
                (_ = f),
                _ > p.threshold && 1 == g)
              ) {
              ...
              2 == g &&
                ((c =
                  t(_, 10, w) -
                  ("front" == s.opts.offCanvas.zposition ? w : 0)),
                u.negative && (c = -c),
                (h = "translate" + u.typeUpper + "(" + c + "px )"),
                y.css({ "-webkit-transform": "-webkit-" + h, transform: h }));
            })
            .on("panend", function() {
              2 == g &&
                (r.$html.removeClass(a.dragging),
                y.css("transform", ""),
                s[l == u.open_dir ? "_openFinish" : "close"]()),
                (g = 0);
            });
        }
      }
  ...
  (o[t].addons[d] = {
    ...
    _add: function() {
      (i = o[t]._c),
        (e = o[t]._d),
        (s = o[t]._e),
        i.add("fixed-top fixed-bottom"),
        (a = o[t].glbl);
    }
  }),
    (o[t].defaults[d] = {}),
    (o[t].configuration.classNames[d] = {
      fixedTop: "FixedTop",
...
!(function(t) {
  ...
  (t[o].addons[e] = {
    ...
    (t[o].defaults[e] = { add: !1, content: !1, title: "", update: !1 }),
  ...
  (e[t].addons[a] = {
    ...
    _setup: function() {
      ...
      if (
        ...
        "object" != typeof s && (s = {}),
        "undefined" == typeof s.content &&
          (s.content = ["prev", "title", "next"]),
        (s = e.extend(!0, {}, e[t].defaults[a], s)),
        (this.opts[a] = s),
        s.add)
      ) {
    ...
    (e[t].defaults[a] = { add: !1, title: "Menu", update: !1 }),
  ...
  (l[e].addons[s] = {
    _init: function(e) {
      ...
      this.__refactorClass(
        ...
        n.collapse &&
          l("." + a.label, e).each(function() {
            var e = l(this),
              s = e.nextUntil("." + a.label, "." + a.collapsed);
            s.length &&
              (e.children("." + a.subopen).length ||
                (e.wrapInner("<span />"),
                e.prepend(
                  '<a href="#" class="' +
                    a.subopen +
    ...
    (l[e].defaults[s] = { collapse: !1 }),
    (l[e].configuration.classNames[s] = { collapsed: "Collapsed" });
  var a, n, o, t;
})(jQuery);
/*	
      ...
      if (l.add) {
        ...
        c.length &&
          c.each(function() {
            ...
            l.noResults &&
              (s.is("." + a.menu) && (s = s.children("." + a.panel).first()),
              (n = s.is("." + a.list) ? "li" : "div"),
              s.children(n + "." + a.noresultsmsg).length ||
                e("<" + n + ' class="' + a.noresultsmsg + '" />')
                  .html(l.noResults)
                  .appendTo(s));
          });
      }
      if (
        (this.$menu.children("." + a.search).length &&
          this.$menu.addClass(a.hassearch),
        l.search)
      ) {
        ...
        h.length &&
          h.each(function() {
            var n = e(this);
            if ("menu" == l.addTo)
              var t = e("." + a.panel, i.$menu),
                d = i.$menu;
            else
              var t = n.closest("." + a.panel),
                d = t;
            ...
            l.showLinksOnly || (p += ", > span"),
              ...
              n
                .off(o.reset + " " + o.search)
                .on(o.reset + " " + o.search, function(e) {
                  e.stopPropagation();
                })
                .on(o.reset, function() {
                  n.trigger(o.search, [""]);
                        ...
                        d.length
                          ...
                          : "menu" == l.addTo &&
                            (n.hasClass(a.opened) &&
                              setTimeout(function() {
                                t.trigger(o.open);
                              }, 1.5 * (s + 1) * i.conf.openingInterval),
                            t.addClass(a.nosubresults));
                      }
                    }),
                    d[
                      f.not("." + a.hidden).length ? "removeClass" : "addClass"
                    ](a.noresults),
                    i._update();
                });
          });
...
!(function(e) {
  ...
  (e[t].addons[s] = {
    _init: function(t) {
      ...
      this.opts[s],
        ...
        e("input." + c.toggle + ", input." + c.check, t).each(function() {
          ...
          s.children('label[for="' + n + '"]').length ||
            (t.attr("id", n),
            s.prepend(t),
            e(
              '<label for="' + n + '" class="' + c[l] + '"></label>'
            ).insertBefore(s.children("a, span").last()));
        });
    },
    _setup: function() {},
    _add: function() {
    ...
    (e[t].defaults[s] = {}),
    (e[t].configuration.classNames[s] = { toggle: "Toggle", check: "Check" });
  var c, a, l, n;
})(jQuery);
