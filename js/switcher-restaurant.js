...
jQuery(document).ready(function($) {
  ...
  jQuery("#dark-blue").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-dark-blue.png"
    );
    return false;
  });
  ...
  jQuery("#light-green").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-light-green.png"
    );
    return false;
  });
  ...
  jQuery("#orange").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-orange.png"
    );
    return false;
  });
  ...
  jQuery("#light-blue").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-light-blue.png"
    );
    return false;
  });
  ...
  jQuery("#purple").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-purple.png"
    );
    return false;
  });
  ...
  jQuery("#yellow").click(function() {
    ...
    jQuery(".link img.time-tab").attr(
      "src",
      "images/timetable-menu-yellow.png"
    );
    return false;
  });
